    ...
    <div class="row">
        <div class="col-lg">
            <div class="card">
                ...
                <hr class="mx-4">
                <div class="card-body">
                    <form action="/buku/lokasi/store" method="POST">
                        <div class="row">
                            <div class="col-12 mb-4">
                                <label for="nama_lokasi" class="mb-2">Nama Lokasi <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text">Text</span>
                                    <input name="nama_lokasi" id="nama_lokasi" class="form-control <?= error("nama_lokasi") ?>" placeholder="Masukkan nama lokasi..." value="<?= old("nama_lokasi") ?>">
