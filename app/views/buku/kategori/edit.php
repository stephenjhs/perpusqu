...
$breadcrumbs = "
    ...
    <li class='breadcrumb-item'><a href='/buku/kategori/edit?id=$id'>Edit Data</a></li>
";

$title = "Data Kategori";
$subtitle = "Kelola data kategori di halaman ini sesuai keperluan.";

$kategori = get("kategori_buku", $id);
    ...
    <div class="row">
        <div class="col-lg">
            <div class="card">
                ...
                <hr class="mx-4">
                <div class="card-body">
                    <form action="/buku/kategori/update" method="POST">
                        ...
                        <div class="row">
                            <div class="col-12 mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="nama_kategori" id="nama_kategori" class="form-control <?= error("nama_kategori") ?>" placeholder="Masukkan nama kategori..." value="<?= old("nama_kategori", $kategori->nama_kategori) ?>">
