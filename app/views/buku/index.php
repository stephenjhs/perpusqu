...
$title = "Data Buku";
$subtitle = "Kelola data buku di halaman ini sesuai keperluan.";
...
<section class="section mb-4">
    <div class="card">
        <div class="card-header pb-2 d-flex justify-content-between align-items-center">
            ...
            <?php if(isAdmin()) : ?>
                <a href="/buku/create" class="btn btn-primary px-4">Tambah Data</a>
            <?php endif ?>
        </div>
        <hr class="mx-4">
        <div class="card-body">
                        ...
                        <?php foreach (all("buku") as $buku) : ?>
                            <tr class="text-nowrap">
                                ...
                                <td>
                                    ...
                                    <?php if(isAdmin()) : ?>
                                        <a href="/buku/edit?id=<?= $buku->id ?>" class="badge bg-warning text-black me-1">Edit</a>
                                        <a href="#" class="badge bg-<?= bukuRelational($buku->id) ? "secondary" : "danger" ?> text-white me-1" data-bs-toggle="modal" data-bs-target="#hapus<?= $buku->id ?>">Hapus</a>
                                    <?php endif ?>
                                </td>
                                <?php if(isAdmin()) : ?>
                                    <div class="modal fade text-left" id="hapus<?= $buku->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel120" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Apakah anda yakin ingin menghapus <b><?= $buku->judul ?></b>? Data yang sudah dihapus tidak dapat dikembalikan!
                                                </div>
                                                    ...
                                                    <div class="col-lg-9">
                                                        <ul class="list-group">
                                                            ...
                                                            <li class="list-group-item d-flex">
                                                                ...
                                                                <div><b><?= $buku->jumlah_buku ?> buah</b></div>
                                                            </li>
                                                            <li class="list-group-item d-flex">
