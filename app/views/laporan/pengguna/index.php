...
$sub_path = "/laporan/pengguna";

$breadcrumbs = "
    <li class='breadcrumb-item'><a href='/laporan'>Laporan</a></li>
    <li class='breadcrumb-item'><a href='/laporan/pengguna'>Pengguna</a></li>
";

$title = "Data Laporan Pengguna";
$subtitle = "Cetak laporan pengguna dengan format PDF.";
                ...
                <div class="card-content">
                    <div class="card-header pb-2 d-flex justify-content-between align-items-center">
                        ...
                        <div class="badge bg-info text-black">
                            <?= amount("pengguna") ?> orang
                        </div>
                    </div>
                    <hr class="mx-4">
                    <div class="card-body">
                        <form action="/laporan/pengguna/print" method="POST">
                            <input hidden name="print" value="pengguna">
                            <div class="row">
