...
$subtitle = "Halaman ini digunakan untuk mengubah password anggota.";

$breadcrumbs = "
    <li class='breadcrumb-item'><a href='/anggota'>Anggota</a></li>
    <li class='breadcrumb-item'><a href='/anggota/edit?id=$id'>Edit Data</a></li>
    <li class='breadcrumb-item'><a href='/anggota/ubahpassword/edit?id=$id'>Ubah Password</a></li>
";
...
<section class="section mb-4">
    <div class="card">
        ...
        <div class="card-content">
            <div class="card-body">
                <form action="/anggota/ubahpassword/update" method="POST">
