	...
	<div class="row">
		<div class="col-lg">
			<div class="card">
				...
				<hr class="mx-4">
				<div class="card-body">
					<form action="/anggota/kelas/store" method="POST">
						<div class="row">
							<div class="col-lg mb-4">
								<label for="nama_kelas" class="mb-2">Nama Kelas <span class="text-danger">*</span></label>
								<div class="input-group">
									<span class="input-group-text">Text</span>
									<input name="nama_kelas" id="nama_kelas" class="form-control <?= error("nama_kelas") ?>" placeholder="Masukkan nama kelas..." value="<?= old("nama_kelas") ?>">
